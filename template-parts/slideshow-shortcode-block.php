<?php
/**
 * Slideshow shortcode block template part
 *
 * @package theme
 * @version 1.0
 */
...
$slideshow_id = get_data_ID( 'slideshow', 'shortcode' );
?>
<div id="slideshow-<?php the_data_ID( 'slideshow', 'shortcode' ); ?>" <?php the_data_class( 'slideshow', 'slideshow' ); the_data_extras( 'slideshow' ); ?>>
<?php
/**
